...
| --- | --- | --- | --- | --- |
| C# | 已适配，主项目与文档标准 | `1.0.0.32` | [YiKdWebClient C#](https://gitee.com/lnsyzjw/yi-kd-web-client) | [YiKdWebClient C#](https://github.com/1609676823/YiKdWebClient) |
...
| PHP | 已纳入适配，进度见 PHP README | 对标 C# `1.0.0.32` | [YiKdWebClient PHP](https://gitee.com/lnsyzjw/yi-kd-web-client-php) | [YiKdWebClient PHP](https://github.com/1609676823/YiKdWebClient-PHP) |
...
如果仅需在 Gitee 不可达时进行本地开发，可从 GitHub 克隆，再用本地 `replace`：

```bash
git clone https://github.com/1609676823/YiKdWebClient-Go.git
go mod edit -replace gitee.com/lnsyzjw/yi-kd-web-client-go=../YiKdWebClient-Go
go mod tidy
```

`replace` 只适合本地开发，发布自己的业务 Module 前通常应移除它。
...
| `scripts/configure-remotes.*` | 仓库维护者 | 将 `origin` 配成 Gitee fetch + Gitee/GitHub 双 push | 否 |
...
6. 确认 `origin` 的两个 push URL，然后推送分支和 Tag：
...
- fetch URL：`https://gitee.com/lnsyzjw/yi-kd-web-client-go.git`
- push URL 1：`https://gitee.com/lnsyzjw/yi-kd-web-client-go.git`
- push URL 2：`https://github.com/1609676823/YiKdWebClient-Go.git`
...
```bash
sh ./scripts/configure-remotes.sh
```
